...
namespace Sneakers_mngmt
{
    interface CRUD
    {
        ...
        void UpdateRecord(string id, Inventory inventorychanges);
    ...
    class SneakerRepository : CRUD
    {
        ...
        {
            var car = entities.Inventories.First(n => n.Sku == id);
            if (car != null)
            {
                return car;
            }
        ...
        public void UpdateRecord(string id, Inventory inventorychanges)
        {
            var invtoupdate = entities.Inventories.Find(id);
            invtoupdate.ItemID = inventorychanges.ItemID;
            invtoupdate.ShoePic = inventorychanges.ShoePic;
